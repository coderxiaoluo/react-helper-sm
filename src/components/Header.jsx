...
const Header = () => {
  ...
  return (
    <header className="bg-[#2C4B5E] text-[#F5F2EB] py-6"> {/* 修改头部背景：使用新主色调 #2C4B5E 黛色 */}
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-center space-x-3">
          <Sword className="h-8 w-8 text-[#F5F2EB]" /> {/* 修改图标颜色：确保在黛色背景下清晰可见 */}
          <h1 className="text-2xl font-bold">逆水寒手游竞技爱好者</h1>
        </div>
        {/* 音乐地方 */}
        <div className="flex items-center justify-center mt-2 space-x-2">
          <p className="text-center text-[#F5F2EB] opacity-90"> {/* 修改头部副标题颜色：使用浅米色，与主色调搭配 */}
